...
class Bloque(pygame.sprite.Sprite):  
    ...
    def llamar(self):
            self.image = pygame.image.load('bomba2.png').convert_alpha()
    # Llamada para cada fotograma.
    def update(self):
        self.rect.x += self.cambio_x
        self.rect.y += self.cambio_y
        pantalla.blit(fondo, (2, 2))
...
class Protagonista(Bloque):
    ...
    def update(self):
      ...
      # Coloca al objeto protagonista en la posición del ratón.
        ...
        self.rect.y = pos[1]
    def llamar(self):
            self.image = pygame.image.load('gas.png').convert_alpha()
...
#pantalla=pygame.display.set_caption("Pruebas Pygame")
